...
Levels.MultirotorObstacles = function()
{
	...
	this.model = new Models.Multirotor({imgURL:'multirotor_lowres.png',	theta: 0,dtheta: 0,x: -2,dx: 0,y: 1,dy: 0});
}
